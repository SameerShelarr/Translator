package com.sameershelar.translator.translate.data.translate

import com.sameershelar.translator.core.domain.language.Language
import com.sameershelar.translator.translate.domain.translate.TranslateClient
import com.sameershelar.translator.translate.domain.translate.TranslateError
import com.sameershelar.translator.translate.domain.translate.TranslateException
...
class KtorTranslateClient(
    ...
    override suspend fun translate(
        ...
        val result = try {
            httpClient.post {
                url("https://tranlate.pl-coding.com/translate")
